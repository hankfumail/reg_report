...
void auxiliary_control_register_report( void )
{
	 ...
	 */
    xil_printf("Auxiliary Control Register: 0x%08x\n\r", u32_aux_ctrl_reg);
...
void secure_config_register_report( void )
{
	...
	{
		xil_printf("Processor mode is in monitor mode\n");
	}
	else
	{
		if( 0 == (u32_secure_config_reg&0x1) )
		{
			xil_printf("Processor mode is in secure mode\n");
		}
		else
		{
			xil_printf("Processor mode is in non-secure mode\n");
		}
	}
}
